  ...
  return (
    <div className="flex flex-col gap-4.5">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(230px,1fr))] gap-3.5">
        <StatCard label="Total courses" value={totalCourses} icon="menu_book" />
        <StatCard label="Total departments" value={totalDepartments} icon="layers" />
        <StatCard label="Total credits" value={totalCredits} icon="military_tech" />
        <StatCard label="Recently added courses" value={recentCount} icon="schedule" />
      </div>
