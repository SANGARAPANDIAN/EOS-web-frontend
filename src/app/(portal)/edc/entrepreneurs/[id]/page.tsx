...
// Real data — GET /me/edc-entrepreneurship, id is the real student_entrepreneurship.id.
export default function EdcStudentProfilePage() {
  ...
  return <EdcVentureDetail row={row} backHref="/edc/entrepreneurs" backLabel="All EDC students" />;
}
