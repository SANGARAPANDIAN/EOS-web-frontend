...
// Note: not scoped to the currently-selected child (no ChildSwitcher here) —
// the backend already aggregates announcements visible to ANY of this
// parent's linked children across all of them, which is more complete for a
// multi-child parent than re-filtering per selection.
  ...
  return (
    <div className="flex flex-col gap-5 animate-pop-in">
      <div>
        ...
        <p className="mt-1 text-[13px] text-muted">Everything posted for your children by the principal, HoD, faculty and offices.</p>
      </div>
