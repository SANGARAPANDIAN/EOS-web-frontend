...
import { useChildTimetableForDay, displayPeriodNumbers } from "@/modules/parent/api/timetable";
...
export default function ParentAttendancePage() {
  ...
  const dayTimetable = useChildTimetableForDay(selectedChildId, selectedDayOfWeek === 0 ? null : selectedDayOfWeek);
