...
import { useChildPerformance, useChildCgpa, type ExamResultGroup, type ExamResultSubject } from "@/modules/parent/api/performance";
...
export default function ParentPerformancePage() {
  ...
  const examResults = useChildPerformance(selectedChildId, effectiveSemester);
  const subjectsLookup = useSubjectsLookup();
  const cgpa = useChildCgpa(selectedChildId, effectiveSemester);
