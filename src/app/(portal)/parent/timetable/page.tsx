...
import { useChildTimetableForDay, useChildFullWeekTimetable, displayPeriodNumbers, type TimetableSlot } from "@/modules/parent/api/timetable";
...
export default function ParentTimetablePage() {
  ...
  const dayTimetable = useChildTimetableForDay(selectedChildId, tab === "today" ? selectedDay : null, tab === "today" ? selectedDateIso : undefined);
  const weekTimetable = useChildFullWeekTimetable(selectedChildId);
