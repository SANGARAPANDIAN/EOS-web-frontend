  ...
  return (
    <>
      <Modal
        ...
        onClose={onClose}
        title="Edit class"
        subtitle={`${course.code} · Section ${classItem.section}`}
        className="max-w-lg"
      >
        ...
        {bySemester.size > 0 && (
          <div className="mt-4 border-t border-divider pt-3.5">
            <p className="mb-2 text-[11px] font-extrabold tracking-[.06em] text-subtle uppercase">
              Subjects (read-only)
            </p>
        ...
        <div className="mt-4.5 flex items-center justify-between border-t border-border-default pt-3.5">
          <Button
            ...
            title={
              studentCountInClass > 0 ? `${studentCountInClass} students in this class — move them first` : "Delete this class"
            }
