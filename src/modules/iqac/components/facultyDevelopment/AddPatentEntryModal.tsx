...
/**
 * Records real faculty_patents/faculty_patent_inventors rows — the
 * redesigned successor to the single-faculty "Add faculty entry" modal.
 * Requires research_development_rename.query.md Section 2 to have run
 * before a student can be added as a contributor; faculty contributors
...
export function AddPatentEntryModal({
  ...
  onClose: () => void;
  onCreated: () => void;
  /** Editing an existing inventorship — the contributor can't be reassigned here (delete + re-add for that); title/stage/filed_year/stage_date edit the shared patent. */
  editing?: PatentRow;
}) {
  ...
  return (
    <Modal open onClose={onClose} title={isEditing ? "Edit entry" : "Add entry"} subtitle="Patents">
